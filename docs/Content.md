# Content Delivery Api Cms

The Content Delivery Api Cms exposes familiar operations from `IContentLoader`, such as Get, GetItems, GetChildren, and GetAncestors, with support for all content versions, personalization, proper access control, and a feature for loading referenced content in the same request.
